...
class DeleteDeveloperUseCase @Inject constructor(private val repository: DeveloperContactsRepository,
    ...
    operator fun invoke(developerRequest: DeveloperRequest): Flow<Resource<StatusResponse>> = flow {
        try {
            ...
            val getSearchedMovie = repository.deleteDeveloper(developerRequest).toAddDeveloper()
